...
if (!isDesktopLinux() && !isAndroidLinux()) {
  ...
  PLAYER_COMMAND = `streamlink ${TWITCH_WATCH_URL}/ ; sleep 1; player=am start -n org.videolan.vlc/org.videolan.vlc.gui.video.VideoPlayerActivity -a android.intent.action.VIEW -d "http://127.0.0.1:8080/"`;
